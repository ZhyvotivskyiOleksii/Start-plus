...
export default function Calculator() {
    ...
    const cities = {
        "Warszawa": 0.00, "Piastów": 30.00, "Pruszków": 30.00, "Piaseczno": 30.00, "Sulejówek": 40.00,
        "Józefów": 70.00, "Kobyłka": 50.00, "Ożarów Mazowiecki": 50.00, "Otwock": 70.00, "Zielonka": 40.00,
        "Legionowo": 40.00, "Józefosław": 60.00, "Nieporęt": 90.00, "Ząbki": 30.00, "Blonie": 50.00,
        "Stare Babice": 30.00, "Brwinów": 50.00, "Grodzisk Mazowiecki": 60.00, "Marki": 30.00, "Raszyn": 25.00,
        "Łomianki": 40.00, "Łazy": 50.00, "Nowa Iwiczna": 50.00, "Wólka": 40.00, "Konstancin-Jeziorna": 50.00,
        "Jabłonna": 40.00, "Nowy Dwór Mazowiecki": 75.00, "Młociny": 60.00, "Sołec": 80.00, "Leszno": 80.00,
        "Milanówek": 50.00, "Izabelin": 70.00, "Nadarzyn": 80.00, "Żyrardów": 90.00, "Wola Krakowska": 100.00,
        "Radzymin": 75.00, "Mińsk Mazowiecki": 80.00, "Nowa Wola": 60.00, "Janki": 45.00, "Góra Kalwaria": 100.00,
        "Mysiadło": 40.00, "Władysławów": 30.00, "Ustanów": 90.00,
    };
    ...
    const frequencyDiscounts = {
        "Raz w tygodniu": 20, "Raz na dwa tygodnie": 15, "Raz w miesiącu": 10, "Jednorazowe sprzątanie": 0,
    };
    ...
    const availableTimes = ["7:30", "8:00", "9:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00", "17:00", "18:00", "19:00", "20:00"];
    ...
    // Завантаження знижок та промокодів
    useEffect(() => {
    ...
    // Обробка вибору кухні та анексу
    ...
    // Розрахунок загальної ціни з урахуванням знижок
    ...
    // Розрахунок ціни для перекреслення
    ...
    // Розрахунок кількості прибиральників і часу
    ...
    // Обробка зміни кількості додаткових послуг
    ...
    return (
        <section className={css["calc-wrap"]}>
            <div className={css.container}>
                <h2 className={css["cacl-title"]}>Sprzątanie mieszkania {selectedCity}</h2>
            ...
            <section className={css["calculator-impuls"]}>
                <div className={css["calculator-container"]}>
                    <div className={css["calculator-left"]}>
                        ...
                        <div className={css["quantity-selector"]}>
                            ...
                            <div className={css.counter}>
                                ...
                                <span className={css["counter-label"]}>
                                    {bathrooms === 1 ? "łazienka" : bathrooms >= 2 && bathrooms <= 4 ? "łazienki" : "łazienek"}
                                </span>
                                <button
                                    className={css["counter-button"]}
                        ...
                        <p className={css.note}>* Kompleksowe sprzątanie całego mieszkania, w tym kuchni, toalety oraz łazienki</p>
                            ...
                            <div className={css["service-block"]}>
                                <div className={css["service-item"]}>
                                    <label className={css["checkbox-label"]}>
                                        <img src="/icon/kitchen.svg" alt="Kitchen" className={css["service-icon"]} />
                                    ...
                                    <div className={css["annex-section"]}>
                                        <label className={css["checkbox-label"]}>
                                            <img src="/icon/kitchen-1.svg" alt="Annex" className={css["service-icon"]} />
                                            <div className={css["checkbox-wrapper"]}>
                                                <input
                                                    type="checkbox"
                        ...
                        <div className={css["vacuum-notice"]}>
                            <label className={css["checkbox-label"]}>
                                <div className={css["icon-checkbox-wrapper"]}>
                                    <img src="/icon/odku.png" alt="Vacuum" className={css["service-icon"]} />
                                    <input
                                        type="checkbox"
                                    ...
                                    <div className={css["time-wrapper"]} ref={timeSlotsRef}>
                                        ...
                                        <div className={css["time-slots"]}>
                                            {availableTimes.map((time) => (
                                                <button
                                                    key={time}
                                                    className={`${css["time-slot"]} ${selectedTime === time ? css.selected : ""}`}
                        ...
                        <div className={css["frequency-section"]}>
                            ...
                            <div className={css["frequency-options"]}>
                                {Object.entries(frequencyDiscounts).map(([freq, freqDiscount]) => {
                                    const freqPrice = (parseFloat(calculateBasePrice()) * (1 - freqDiscount / 100)).toFixed(2);
                                    const isSelected = cleaningFrequency === freq;

                                    return (
                                        <div
                                            key={freq}
                                            className={`${css["frequency-option"]} ${isSelected ? css.selected : ""}`}
                                        ...
                                        >
                                            <div className={css["frequency-content"]}>
                                                ...
                                                {freq === "Jednorazowe sprzątanie" && <span className={css["emoji"]}></span>}
                                            </div>
                                        </div>
                                    );
                                })}
                        ...
                        <div className={css["paid-services-section"]}>
                            ...
                            <div className={css["paid-services-grid"]}>
                                {paidServices.map((service) => (
                                    <div
                                        key={service.id}
                                        className={`${css["paid-service-card"]} ${(service.type === "checkbox" && selectedServices[service.id]) || (service.type === "quantity" && selectedServices[service.id] > 0) ? css.selected : ""}`}
                                        onClick={() => handleServiceToggle(service.id)}
                                    >
                                        <img src={service.icon} alt={service.name} className={css["service-icon"]} />
                                        <p>{service.name}</p>
                                        <div className={css["price-wrapper"]}>
                                            <span className={css["price-new"]}>{service.price.toFixed(2)} zł</span>
                                            {service.oldPrice && <span className={css["price-old"]}>{service.oldPrice.toFixed(2)} zł</span>}
                                        </div>
                                        {service.type === "checkbox" && selectedServices[service.id] ? (
                                            ...
                                            <div className={css["quantity-controls"]}>
                                                ...
                                                <span className={css["qty-value"]}>{selectedServices[service.id]}</span>
                                                <button
                                                    className={css["qty-btn"]}
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                        ...
                        <div className={css["address-section"]}>
                            ...
                            <div className={css["city-select"]}>
                                <button className={css["city-button"]} onClick={() => setShowCityDropdown(!showCityDropdown)}>
                                ...
                                {showCityDropdown && (
                                    <div className={css["city-dropdown"]}>
                                        ...
                                        {filteredCities.map(([city, cost]) => (
                                            <button
                                                key={city}
                                                className={`${css["city-option"]} ${selectedCity === city ? css.selected : ""}`}
                                                onClick={() => {
                    ...
                    <div className={css["calculator-right"]} ref={rightBlockRef}>
                        <h2>
                            Sprzątanie mieszkania z {rooms} {rooms === 1 ? "pokój" : rooms >= 2 && rooms <= 4 ? "pokoje" : "pokoi"} i {bathrooms} {bathrooms === 1 ? "łazienka" : bathrooms >= 2 && bathrooms <= 4 ? "łazienki" : "łazienek"}{kitchen ? ", kuchnia" : kitchenAnnex ? ", aneks kuchenny" : ""}, przedpokój
                            <br />
                        ...
                        <div className={css["specialist-info"]}>
                            ...
                            <p>Nasi wykonawcy posiadają wszystkie niezbędne środki czystości oraz sprzęt.</p>
                        </div>
                        ...
                        {calculateCleanersAndTime().cleaners > 1 && (
                            <div className={css.cleaners}>
                                {Array.from({ length: calculateCleanersAndTime().cleaners }, (_, i) => (
                                    <span key={i} className={css["cleaners-icon"]}>👤</span>
                                ))}
                        ...
                        <div className={css["selected-date"]}>
                            ...
                            {selectedDate && selectedTime ? (
                                <p>
                                    ...
                                    {selectedDate && discounts[`${selectedDate.getFullYear()}-${String(selectedDate.getMonth() + 1).padStart(2, "0")}-${String(selectedDate.getDate()).padStart(2, "0")}`] && (
                                        <span className={css["discount-inline"]}>-{discounts[`${selectedDate.getFullYear()}-${String(selectedDate.getMonth() + 1).padStart(2, "0")}-${String(selectedDate.getDate()).padStart(2, "0")}`]}%</span>
                                    )}
                                </p>
                            ) : (
                        ...
                        <div className={css["selected-frequency"]}>
                            <p>
                                ...
                                {frequencyDiscounts[cleaningFrequency] > 0 && (
                                    <span className={css["discount-inline"]}>-{frequencyDiscounts[cleaningFrequency]}%</span>
                                )}
                            </p>
                        </div>
                        ...
                        <div className={css["selected-services-container"]}>
                            {paidServices.map((service) =>
                                (service.type === "checkbox" && selectedServices[service.id]) || (service.type === "quantity" && selectedServices[service.id] > 0) ? (
                                    <div key={service.id} className={css["selected-service-item"]} style={{ position: "relative" }}>
                                        <div className={css["service-info"]}>
                                            <img src={service.icon} alt={service.name} className={css["selected-service-icon"]} />
                                            <p>{service.name}{service.type === "quantity" && ` (${selectedServices[service.id]}${service.id === 9 || service.id === 11 ? " god" : "x"})`}</p>
                                        </div>
                                        <div className={css["service-price"]}>
                                            <p>{(service.type === "checkbox" ? service.price : service.price * selectedServices[service.id]).toFixed(2)} zł</p>
                                        </div>
                                        <button
                                            className={css["remove-btn"]}
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                service.type === "checkbox" ? handleServiceToggle(service.id) : handleQuantityChange(service.id, -selectedServices[service.id]);
                                            }}
                                        >
                                            ×
                                        </button>
                            ...
                            {vacuumNeeded && (
                                <div key="vacuum" className={css["selected-service-item"]} style={{ position: "relative" }}>
                                    <div className={css["service-info"]}>
                                        <img src="/icon/odku.png" alt="Vacuum" className={css["selected-service-icon"]} />
                                        <p>Przywieziemy ręczny odkurzacz do sprzątania</p>
                                    </div>
                                    <div className={css["service-price"]}>
                                        <p>{vacuumCost.toFixed(2)} zł</p>
                                    </div>
                                    <button className={css["remove-btn"]} onClick={(e) => { e.stopPropagation(); setVacuumNeeded(false); }}>
                                        ×
                                    </button>
                                </div>
                            )}
                        ...
                        <div className={css["promo-code"]}>
                            <div className={css["promo-container"]}>
                                ...
                                <input type="text" placeholder="Promokod" value={promo} onChange={(e) => setPromo(e.target.value)} />
                        ...
                        <div className={css.total}>
                            <p>
                                <strong>Do zapłaty:</strong> {calculateTotal()} zł <del>{calculateStrikethroughPrice()} zł</del>
                            </p>
                            {error && <p className={css["error-message"]}>{error}</p>}
                            <button className={`${css["sticky-order-button"]} ${isSticked ? css.sticked : ""}`} onClick={handleOrder}>
